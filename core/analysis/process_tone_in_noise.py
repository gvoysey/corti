...
def plot_w5peaklatency_vs_snr(traj: Trajectory, pdf):
    ...
    conditions = {
        ...
        'verhulst_no_weight_carney': [run for run in traj.res.runs if run.periphery.modelType.casefold() == "verhulst" and
                                      not run.periphery.cf_weighting and
                                      run.brainstem.modeltype.modeltype.casefold() == "carney2015"],
        'verhulst_weighted_nc04': [run for run in traj.res.runs if run.periphery.modelType.casefold() == "verhulst" and
                                   run.periphery.cf_weighting and
                                   run.brainstem.modeltype.modeltype.casefold() == "nelsoncarney04"],
        'verhulst_weighted_carney': [run for run in traj.res.runs if run.periphery.modelType.casefold() == "verhulst" and
                                     run.periphery.cf_weighting and
                                     run.brainstem.modeltype.modeltype.casefold() == "carney2015"],
...
def plot_vs_snr(traj: Trajectory, pdf):
    # containing many SNRs and many neuropathies
    conditions = {
        'verhulst_no_weight_nc04': [run for run in traj.res.runs if run.periphery.modelType.casefold() == "verhulst" and
                                    not run.periphery.cf_weighting and
